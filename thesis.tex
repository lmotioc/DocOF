...
\renewcommand{\thesisauthor}{Laura MOTIOC}    %% Your name.
...
\begin{figure}
	\label{rsults}
	\centering
	\subfloat{\includegraphics[width = 2in]{img/groove}} 
	\subfloat{\includegraphics[width = 2in]{img/groovelmn}} 
	\subfloat{\includegraphics[width = 2in]{img/grooveppp}} \\
	\subfloat{\includegraphics[width = 2in]{img/city}} 
	\subfloat{\includegraphics[width = 2in]{img/citylmn}} 
	\subfloat{\includegraphics[width = 2in]{img/cityppp}} \\
	\subfloat{\includegraphics[width = 2in]{img/frame10}} 
	\subfloat{\includegraphics[width = 2in]{img/walelmn}} 
	\subfloat{\includegraphics[width = 2in]{img/waleppp}} \\
...
In this chapter we specify the resources needed to run our application and the setup steps towards lunching the application. We also describe the input parameters.
...
\begin{enumerate}
	\item Copy the contents of the CD to \path{C:\ } or other local disk and extract the archive.
	\item Start MATLAB.
	\item Set MATLAB working directory to \path{C:\...\lmn\}. See figure a
		\begin{figure}
			\centering
				\subfloat[]{\includegraphics[width = 3in]{img/path}} 	\label{path}
				\subfloat[]{\includegraphics[width = 1.5in]{img/commandw}} \label{commw}
			\caption{Path Selection}
		\end{figure}
	\item In the MATLAB command window, type the following command:\textit{OpticalFlow}. See figure b
	\end{enumerate}
...
\section{Further development}
 ...
 A pre and post processing phase should fallow, to improve the accuracy of the results.
 
 Also this algorithm keeps room for extension. This approach is a general solution an in can be applied to any combination of $L^1$ $L^2$ norm. For the future the algorithm could be applied on a $L^1$-$L^1$ formulation tu further increase robustness. 
