...
\begin{figure}
	\subfloat[fig 1]{\includegraphics[width = 3in]{img/frame10}} 
	\subfloat[fig 2]{\includegraphics[width = 3in]{img/realflow}}
%	\subfloat[fig 3]{\includegraphics[width = 3in]{img/HSPyrExample/RegularHS}}
%	\subfloat[fig 4]{\includegraphics[width = 3in]{img/HSPyrExample/HSwithPyr}} 
